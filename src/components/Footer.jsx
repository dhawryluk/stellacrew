    ...
    <footer className="w-full bg-bg px-6 py-12 border-t border-accent/10 mt-20">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-10">
        ...
        <div className="flex items-center gap-6 order-1">
          ...
          <span className="hidden md:block text-text-main/20 text-[10px] uppercase tracking-widest border-l border-white/5 pl-6">
            © 2026
          </span>
        </div>
        ...
        <div className="flex flex-col items-center gap-3 order-2">
          <p className="text-[8px] md:text-[9px] tracking-[0.4em] text-text-main/30 uppercase italic">
            Architects of Excellence
          </p>
          <a href="/terms" className="text-[9px] md:text-[10px] tracking-[0.5em] text-text-main/50 uppercase hover:text-accent transition-all duration-300 border-b border-transparent hover:border-accent/30 pb-1">
            Terms & Protocols
          </a>
        </div>

        {/* Socials Section - All Hovering to Gold */}
