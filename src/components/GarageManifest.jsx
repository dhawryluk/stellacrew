        ...
        {isOpen && (
          <div className="p-10 pt-0 animate-in fade-in slide-in-from-top-4 duration-500">
            <div className="border-t border-white/5 pt-10">
              ...
              <div className="mb-10 p-6 bg-accent/3 border border-accent/20 relative">
              ...
              <div className="bg-[#070707] border border-white/5">
                <div className="grid grid-cols-4 bg-white/2 py-5 px-8 text-[9px] font-black uppercase tracking-[0.4em] text-accent/60 border-b border-white/5">
                  <span>DM_SLOT</span>
                  <span>CHAR_ID</span>
                  <span>ZONE_LOC</span>
                ...
                <div className="max-h-125 overflow-y-auto custom-scrollbar">
                  {data.map((item, i) => (
                    <div
                      key={i}
                      className="grid grid-cols-4 py-5 px-8 bg-transparent border-b border-white/2 items-center hover:bg-accent/2 transition-all group/row"
                    >
                      <div className="flex items-center gap-3">
              ...
              <div className="mt-8 pt-6 border-t border-white/5 flex justify-between items-center opacity-20">
                ...
                <span className="text-[8px] text-accent font-mono">SC_SYNC_LOCKED</span>
              </div>
            </div>
          </div>
        )}
